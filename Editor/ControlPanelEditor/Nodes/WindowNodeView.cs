...
// {
    ...
    { 
        ...
        public WindowNodeView(MyEditor.NodeBase node, MainScreenView mainScreenView) : base(Path.Combine(GetScriptPath(), "WindowNodeView.uxml"))
        {
        ...
        private void SetupStyleNode(MyEditor.NodeBase node)
        {
